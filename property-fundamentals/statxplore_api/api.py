    ...
    def get_universal_credit_date(self, endpoint, ward_codes) -> dict:
        ...
        "recodes": {
          ...
          "str:field:UC_Households:F_UC_DATE:DATE_NAME": {
            "map": [
              [
                "str:value:UC_Households:F_UC_DATE:DATE_NAME:C_UC_DATE:202105"
              ]
            ],
            "total": False
          }
        ...
        data2= {
            ...
            "recodes": {
              ...
              "str:field:hb_new:F_HB_NEW_DATE:NEW_DATE_NAME": {
                "map": [
                  [
                    "str:value:hb_new:F_HB_NEW_DATE:NEW_DATE_NAME:C_HB_NEW_DATE:202105"
                  ]
                ],
                "total": False
              }
        ...
        data2= {
            ...
            "recodes": {
              ...
              "str:field:hb_new:F_HB_NEW_DATE:NEW_DATE_NAME": {
                "map": [
                  [
                    "str:value:hb_new:F_HB_NEW_DATE:NEW_DATE_NAME:C_HB_NEW_DATE:202102"
                  ]
                ],
                "total": False
              }
