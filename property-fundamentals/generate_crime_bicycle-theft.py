...
kml.save(district + "_crime_bicycle-theft" + ".kml")
        
zf = zipfile.ZipFile(district + "_crime_bicycle-theft" + ".kmz", "w")
zf.write("images/icon-13.png")
zf.write(district + "_crime_bicycle-theft" + ".kml")
zf.close()