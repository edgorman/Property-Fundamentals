...
kml.save(district + "_crime_possession-of-weapons" + ".kml")
        
zf = zipfile.ZipFile(district + "_crime_possession-of-weapons" + ".kmz", "w")
zf.write("images/icon-18.png")
zf.write(district + "_crime_possession-of-weapons" + ".kml")
zf.close()