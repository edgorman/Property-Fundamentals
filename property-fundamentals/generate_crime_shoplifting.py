...
kml.save(district + "_crime_shoplifting" + ".kml")
        
zf = zipfile.ZipFile(district + "_crime_shoplifting" + ".kmz", "w")
zf.write("images/icon-20.png")
zf.write(district + "_crime_shoplifting" + ".kml")
zf.close()