...
kml.save(district + "_crime_criminal-damage-arson" + ".kml")
        
zf = zipfile.ZipFile(district + "_crime_criminal-damage-arson" + ".kmz", "w")
zf.write("images/icon-15.png")
zf.write(district + "_crime_criminal-damage-arson" + ".kml")
zf.close()