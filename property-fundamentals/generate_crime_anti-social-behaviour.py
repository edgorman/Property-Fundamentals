...
kml.save(district + "_crime_anti-social-behaviour" + ".kml")
        
zf = zipfile.ZipFile(district + "_crime_anti-social-behaviour" + ".kmz", "w")
zf.write("images/icon-12.png")
zf.write(district + "_crime_anti-social-behaviour" + ".kml")
zf.close()