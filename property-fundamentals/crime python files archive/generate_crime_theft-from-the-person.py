...
kml.save(district + "_crime_theft-from-the-person" + ".kml")
        
zf = zipfile.ZipFile(district + "_crime_theft-from-the-person" + ".kmz", "w")
zf.write("images/icon-17.png")
zf.write(district + "_crime_theft-from-the-person" + ".kml")
zf.close()