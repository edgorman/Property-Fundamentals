...
kml.save(district + "_crime_public-order" + ".kml")
        
zf = zipfile.ZipFile(district + "_crime_public-order" + ".kmz", "w")
zf.write("images/icon-19.png")
zf.write(district + "_crime_public-order" + ".kml")
zf.close()