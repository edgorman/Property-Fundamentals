...
kml.save(district + "_crime_vehicle-crime" + ".kml")
        
zf = zipfile.ZipFile(district + "_crime_vehicle-crime" + ".kmz", "w")
zf.write("images/icon-21.png")
zf.write(district + "_crime_vehicle-crime" + ".kml")
zf.close()