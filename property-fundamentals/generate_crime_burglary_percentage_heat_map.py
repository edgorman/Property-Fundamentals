...
colour = ['2D1400FF', '321400FF', '371400FF', '3C1400FF', '411400FF', '461400FF', '4B1400FF', '501400FF', '551400FF' ,'5A1400FF', '5F1400FF', '641400FF', '691400FF', '6E1400FF', '731400FF', '781400FF', '7D1400FF', '821400FF', '871400FF', '8C1400FF', '911400FF', '961400FF', '9B1400FF', 'A01400FF', 'A51400FF', 'AA1400FF', 'AF1400FF', 'B41400FF', 'B91400FF', 'BE1400FF']
...
for crime in results1:
    if (float(crime['location']['latitude']) <= max_lat) and (float(crime['location']['latitude']) >= min_lat) and (float(crime['location']['longitude']) <= max_lng) and (float(crime['location']['longitude']) >= min_lng):
        ...
        burglary_ward = postcodes_api.get_ward(str(crime['location']['longitude']),str(crime['location']['latitude']))
...
# plt.barh(y_pos[0:34], xaxis[0:34], color = colouraxis[0:34], edgecolor='black') #color = (R,G,B)
...
# plt.rcParams["figure.dpi"] = 200
# plt.rcParams.update({'font.size': 5})
# plt.barh(y_pos[35:69], xaxis[35:69], color = colouraxis[35:69], edgecolor='black') #color = (R,G,B)
