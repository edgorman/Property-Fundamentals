...
#plot the data
plt.barh(y_pos, school_count_poor, label='Poor', color = 'red', edgecolor='black', left=school_count_requires_improvement+school_count_good+school_count_outstanding)
plt.barh(y_pos, school_count_requires_improvement, label='Requires Improvement', color = 'yellow', edgecolor='black', left=school_count_good+school_count_outstanding)
plt.barh(y_pos, school_count_good, label='Good', color = 'springgreen', edgecolor='black', left=school_count_outstanding)
plt.barh(y_pos, school_count_outstanding, label='Outstanding', color = 'green', edgecolor='black')
