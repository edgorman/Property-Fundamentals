...
import { OutlineStyle, HighlightStyle, OutlineStyle2, FillStyle, OutlineHiddenStyle } from "./Style";
...
export default class MapLayers extends React.Component {
    ...
    render() {
        let filter = ['==', '', ''];
        if ("LAD22CD" in this.props.highlight) {
            filter = ['==', 'LAD22CD', this.props.highlight['LAD22CD']]
        }
        else if ("WD22CD" in this.props.highlight) {
